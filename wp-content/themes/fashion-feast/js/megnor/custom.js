...
jQuery(window).load(function() {
    "use strict";
    jQuery(".slider-loading").delay().fadeOut("slow");
})
...
jQuery(document).ready(function() {
  ...
  jQuery(".upsells.products ul, .related.products ul, .cross-sells ul, .products_block ul").addClass("grid");
  jQuery("#secondary .widget_pages ul").addClass("treeview-list");
  jQuery(".tagcloud").addClass("main-ul");
    jQuery("#calendar_wrap").addClass("main-ul");
    jQuery(".price_slider_wrapper").addClass("main-ul");
    jQuery("#primary-sidebar #searchform").addClass("main-ul");
    jQuery(".newsletter").addClass("animated");
  jQuery(".newsletter").attr("data-animated","fadeInRight");
    Shadowbox.init({
        overlayOpacity: .8
    }, setupDemos);
    ...
    jQuery(".tagcloud, .primary-sidebar select,.primary-sidebar .widget_text .textwidget,.primary-sidebar .woocommerce-product-search").addClass("main-ul");
...
jQuery(document).ready(listgrid);
  jQuery('#link-btn').click( function() {
    jQuery(".header-links").slideToggle("slow");;
  });  
  jQuery(".accordion.style5 .single_accordion").each(function(e) {
   ...
   jQuery(".woocommerce ul.products li.product .image-block").each(function(e) {
        jQuery(this).prepend("<div class='detail-block'> </div>");
    });
   jQuery(".woocommerce ul.products li.product-category ").each(function(e) {
        jQuery(this).wrapInner("<div class='container-inner'></div>");
    });
  jQuery(".woocommerce ul.products li .container-inner").find(".yith-wcqv-button").each(function(i){
     jQuery(this).prependTo(jQuery(this).parent().parent().find(".detail-block"));
    });
  jQuery(".woocommerce ul.products li .container-inner").find("a.button").each(function(i){
     jQuery(this).prependTo(jQuery(this).parent().parent().find(".detail-block"));
    });
  jQuery(".woocommerce ul.products li .container-inner").find(".product_type_simple").each(function(i){
     jQuery(this).prependTo(jQuery(this).parent().parent().find(".detail-block"));
    });
  jQuery(".woocommerce ul.products li .container-inner").find(".yith-wcwl-add-to-wishlist").each(function(i){
     jQuery(this).prependTo(jQuery(this).parent().parent().find(".detail-block"));
    });
...
{
  "use strict";
  jQuery('.product-categories, .widget_categories').addClass('treeview-list');
  jQuery(".product-categories.treeview-list,  .widget_categories.treeview-list").treeview({
    animated: "slow",
    collapsed: true,
    unique: true    
  });
...
{
  "use strict";
  jQuery('.widget_nav_menu ul').addClass('treeview-list');
  jQuery(".widget_nav_menu ul.treeview-list").treeview({
    animated: "slow",
    collapsed: true,
    unique: true    
  });
...
jQuery(document).ready(leftNavMenu);
jQuery(document).ready(function() {
    "use strict";
...
jQuery(window).load(function() {
    "use strict";
    jQuery(".flexslider_home-slide").flexslider()
});
/* JS for Flexslider loading image */
jQuery(window).load(function() {
    "use strict";
    jQuery(".flexslider_abt-slider").flexslider({
  controlNav: true,               
    directionNav: false,                       
  });
});
/* JS for move the crosssale below cart total */
function preloadFunc()  { "use strict";  jQuery(".cart_totals ").prependTo(".cart-collaterals");   }
jQuery(document).ready(function() {
    "use strict";
    preloadFunc()
});
function moreTab() {
"use strict";
 if (jQuery(window).width() > 979 && jQuery(window).width() < 1220) {  
  var max_elem = 5 ;
