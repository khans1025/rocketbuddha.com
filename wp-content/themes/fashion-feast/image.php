  ...
  <section id="primary" class="content-area image-attachment">
	...
	?>
      <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        <header class="entry-header">
          ...
          <div class="entry-meta"> <span class="entry-date">
            ...
            <?php edit_post_link( __( 'Edit', 'fashion-feast' ), '<span class="edit-link">', '</span>' ); ?>
          </div>
          <!-- .entry-meta -->
        </header>
        <!-- .entry-header -->
      ...
      <nav id="image-navigation" class="navigation image-navigation">
        <div class="nav-links">
          <?php previous_image_link( false, '<div class="previous-image">' . __( 'Previous Image', 'fashion-feast' ) . '</div>' ); ?>
          <?php next_image_link( false, '<div class="next-image">' . __( 'Next Image', 'fashion-feast' ) . '</div>' ); ?>
        </div>
        <!-- .nav-links -->
      </nav>
      <!-- #image-navigation -->
