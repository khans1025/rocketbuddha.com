...
function templatemela_setup() {
	...
	register_nav_menus( array(
		 'primary'   => __( 'TM Header Navigation', 'fashion-feast' ),
    	 'header-links'   => __( 'TM Header Shop Links', 'fashion-feast' ),
    	 'footer-menu'   => __( 'TM Footer Navigation', 'fashion-feast' ),
	) );
	/*
 ...
 * replace to change 'fashion-feast' to the name of your theme in all
 * template files.
 */
function templatemela_textdomain_setup() {	
	load_theme_textdomain( 'fashion-feast', get_template_directory() . '/languages' );
	$locale = get_locale();
...
function templatemela_widgets_init() {
	register_sidebar( array(
		'name' => __( 'Main Sidebar', 'fashion-feast' ),
		'id' => 'sidebar-1',
		'description' => __( 'Appears on posts and pages except the optional Front Page template, which has its own widgets', 'fashion-feast' ),
...
function templatemela_fonts_url() {
	 ...
	 */
	$source_sans_pro = _x( 'on', 'Source Sans Pro font: on or off', 'fashion-feast' );
	/* Translators: If there are characters in your language that are not
	 * supported by Bitter, translate this to 'off'. Do not translate into your
	 * own language.
	 */
	$bitter = _x( 'on', 'Bitter font: on or off', 'fashion-feast' );
...
function templatemela_scripts_styles() {
	...
	wp_enqueue_style( 'templatemela-style', get_stylesheet_uri(), array(), '1.0' );
	/*
	...
	wp_enqueue_script( 'templatemela-script', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '', true );
...
<div class="contributor">
  <div class="contributor-info">
    ...
    <div class="contributor-summary">
      ...
      <a class="contributor-posts-link" href="<?php echo esc_url( get_author_posts_url( $contributor_id ) ); ?>"> <?php printf( _n( '%d Article', '%d Articles', $post_count, 'fashion-feast' ), $post_count ); ?> </a> </div>
    <!-- .contributor-summary -->
  </div>
  <!-- .contributor-info -->
</div>
...
function templatemela_wp_title( $title, $sep ) {
	...
	if ( $paged >= 2 || $page >= 2 ) {
		$title = "$title $sep " . sprintf( __( 'Page %s', 'fashion-feast' ), max( $paged, $page ) );
	}
	return $title;
}
