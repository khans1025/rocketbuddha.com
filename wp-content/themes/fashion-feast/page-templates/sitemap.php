      ...
      <div class="archive-content">
        ...
        <div class="one_third">
          <div class="sitemap-category">
            <h2>
              <?php _e( 'Category Archives','fashion-feast'); ?>
            </h2>
            <ul>
              <?php wp_list_categories( array( 'feed' => __( 'RSS', 'fashion-feast' ), 'show_count' => true, 'use_desc_for_title' => false, 'title_li' => false ) ); ?>
            </ul>
          </div>
          <div class="clear"></div>
          <div class="sitemap-month-archieves">
            <h2>
              <?php _e( 'Monthly Archives','fashion-feast'); ?>
            </h2>
            <ul>
          ...
          <div class="sitemap-authors">
            <h2>
              <?php _e( 'Author Archives','fashion-feast'); ?>
            </h2>
            <ul>
        ...
        <div class="one_third last">
          <div class="sitemap-posts">
            <h2>
              <?php _e( 'Blog Posts','fashion-feast'); ?>
            </h2>
            <ul>
              <?php 
				$archivesquery = new WP_Query('showposts=20');
				while ($archivesquery->have_posts()) : $archivesquery->the_post(); ?>
              <li> <a href="<?php the_permalink() ?>"  rel="bookmark" title="<?php printf( __("Permanent Link to %s", 'fashion-feast'), get_the_title() ); ?>">
                <?php the_title(); ?>
                </a> (
