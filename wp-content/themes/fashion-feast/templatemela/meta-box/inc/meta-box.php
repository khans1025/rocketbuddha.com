	...
	class RW_Meta_Box
	{
		...
		function admin_enqueue_scripts()
		{
			...
			if ( 'post' != $screen->base || ! in_array( $screen->post_type, $this->meta_box['pages'] ) )
				return;
			wp_enqueue_style( 'fashion-feast', RWMB_CSS_URL . 'style.css', array(), RWMB_VER );
				...
				echo '
					...
					if ( typeof rwmb == "undefined" )
					{
						var rwmb = {
							...
							summaryMessage : "' . __( 'Please correct the errors highlighted below and try again.', 'fashion-feast' ) . '"
						};
					}
					else
					{
