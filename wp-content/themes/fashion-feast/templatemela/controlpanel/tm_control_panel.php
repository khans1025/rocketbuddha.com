...
<?php /*?>	<?php if( (get_option('tmoption_navfont') == "Other+Fonts") || get_option('tmoption_navfont') == "please-select"){  
        ...
        <form method="post" id="panel_form" name="panel_form">
          ...
          <div class="tm-panel-block">
            <div class="tm-panel-title">
              <?php _e('Header font','fashion-feast');?>
            </div>
            <?php 
          ...
          <div class="tm-panel-block">
            <div class="tm-panel-title">
              <?php _e('Link Color','fashion-feast');?>
            </div>
            <?php
          ...
          <div class="tm-panel-block">
            <div class="tm-panel-title-back">
              <?php _e('Footer Link Color','fashion-feast');?>
            </div>
            <?php
          ...
          <div class="more-set"> <a style="color:#000; font-size:12px;" href="<?php echo esc_url(admin_url()); ?>admin.php?page=tm_theme_settings" target="_blank">
            <?php _e('See more settings in admin panel','fashion-feast');?>
            </a> </div>
          <!--more-set-->
        </form>
        <!--panel_form-->
