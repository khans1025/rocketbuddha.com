...
$TM_META_BOXES[] = array(
	...
	'title' 	=> __('TM - Short Description', 'fashion-feast'),
	'pages' 	=> array( 'post' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
...
$TM_META_BOXES[] = array(
	'id'		=> 'tm_posts_options',
	'title' 	=> __('TM - Post Options', 'fashion-feast'),
	'pages' 	=> array( 'post' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
	'fields' 	=> array(
		...
		array(
			'name'    		=> __('Show Related Posts on single post:', 'fashion-feast'),
		...
		array(
			'name'    		=> __('Show Author Info on single post:', 'fashion-feast'),
...
$TM_META_BOXES[] = array(
	...
	'fields' 	=> array(	
		...
		array(
			'name'    		=> __('Display Options:', 'fashion-feast'),
			'id'      		=> "{$prefix}display",
			'type'    		=> 'radio',
			'std'			=> 'grid',
			'options'		=> array(
...
$TM_META_BOXES[] = array(
	...
	'title' 	=> __('TM - Filter Options', 'fashion-feast'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
