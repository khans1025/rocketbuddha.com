...
function templatemela_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php _e( 'Posts navigation', 'fashion-feast' ); ?></h1>
...
function templatemela_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php _e( 'Post navigation', 'fashion-feast' ); ?></h1>
		<div class="nav-links">
			<?php
			if ( is_attachment() ) :
				previous_post_link( '%link', __( '<span class="meta-nav">Published In</span>%title', 'fashion-feast' ) );
			else :
				previous_post_link( '%link', __( '<i class="fa fa-chevron-left"></i>%title', 'fashion-feast' ) );
				next_post_link( '%link', __( '%title<i class="fa fa-chevron-right"></i>', 'fashion-feast' ) );
			endif;
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
